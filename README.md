...
I wanted to be able to read Bible books on an e-paper reader device but EPUB containing all books were impractical. I
also wanted to have the Wikipedia article in the same document to get some context.
